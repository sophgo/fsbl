...
{
	mmio_clrsetbits_32(G11_IO_BASE + 0x1c, IO_MASK, (PAD_MASK | PULL_DOWN | DRIVE_VALUE(4)));	//CLK
	mmio_clrsetbits_32(G11_IO_BASE + 0x20, IO_MASK, (PAD_MASK | PULL_UP | DRIVE_VALUE(3)));		//CMD
	mmio_clrsetbits_32(G11_IO_BASE + 0x24, IO_MASK, (PAD_MASK | PULL_UP | DRIVE_VALUE(3)));		//D0
	mmio_clrsetbits_32(G11_IO_BASE + 0x28, IO_MASK, (PAD_MASK | PULL_UP | DRIVE_VALUE(3)));		//D1
	mmio_clrsetbits_32(G11_IO_BASE + 0x2c, IO_MASK, (PAD_MASK | PULL_UP | DRIVE_VALUE(3)));		//D2
	mmio_clrsetbits_32(G11_IO_BASE + 0x30, IO_MASK, (PAD_MASK | PULL_UP | DRIVE_VALUE(3)));		//D3
}
