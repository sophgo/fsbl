...
size_t emmc_boot2_read_blocks(int lba, uintptr_t buf, size_t size)
{
	return emmc_partition_read_blocks(EMMC_PARTITION_BOOT2, lba, buf, size);
}

size_t emmc_boot2_write_blocks(int lba, uintptr_t buf, size_t size)
{
	return emmc_partition_write_blocks(EMMC_PARTITION_BOOT2, lba, buf, size);
}
