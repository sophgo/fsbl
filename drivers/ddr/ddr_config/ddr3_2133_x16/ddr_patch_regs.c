...
struct regpatch ddr_patch_regs[] = {
	...
	// BYTE0 RX DQ deskew
	{0x08000b00, 0xFFFFFFFF, 0x05030705},
	{0x08000b04, 0xFFFFFFFF, 0x03030405},
	// BYTE0  DQ8 deskew [6:0] neg DQS  [15:8]  ;  pos DQS  [23:16]
	{0x08000b08, 0xFFFFFFFF, 0x002c3006},

	// BYTE1 RX DQ deskew
	{0x08000b30, 0xFFFFFFFF, 0x04030204},
	{0x08000b34, 0xFFFFFFFF, 0x03030403},
	// BYTE1  DQ8 deskew [6:0] neg DQS  [15:8]  ;  pos DQS  [23:16]
	{0x08000b38, 0xFFFFFFFF, 0x002a3004},

	// //Read gate TX dline + shift
	// // BYTE0
	{0x08000b0c, 0xFFFFFFFF, 0x00000d60},
	// // BYTE1
	{0x08000b3c, 0xFFFFFFFF, 0x00000d60},
