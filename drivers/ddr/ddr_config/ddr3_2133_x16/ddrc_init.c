...
void ddrc_init(void)
{
	...
	mmio_wr32(0x08004000 + 0x6c, 0x21000003);
	// PATCH5.vpr_fix:0:1=0x1
	// PATCH5.vpw_fix:1:1=0x1
	// PATCH5.wrcam_collision_disable:2:1=0x0
	// PATCH5.rdcam_collision_disable:3:1=0x0
	// PATCH5.rcam_entry_del_length:4:2=0x0
	// PATCH5.auto_cam_size:24:1=0x1
	// PATCH5.burst_rdwr_xpi_min:28:4=0x2  
	...
	mmio_wr32(0x08004000 + 0x110, 0x07022408);//tccd for tx/rx seperate
...
{
	// enable auto PD/SR
	mmio_wr32(0x08004000 + 0x30, 0x00000a02);
