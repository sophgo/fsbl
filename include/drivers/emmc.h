...
/* we shall prepare 4 copies in BOOT1 partition */
#define EMMC_BOOT1_COPY_NUM		4
#define EMMC_BOOT1_COPY_SIZE		(1 * 1024 * 1024)
...
void emmc_init(const emmc_ops_t *ops, int clk, int bus_width,unsigned int flags);
