...
#define  DDR_PHY_REG_36_DATA  0b00000000000000000011100000000000 //rdlvl training mode and dqs late disable for bring up
...
#define  DDR_PHY_REG_47_DATA  0b00000010000010000011111000000011  //wdqlvl training mode disable for bring up
