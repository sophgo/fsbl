...
/** Precise burst available values */
typedef enum
{
    CUSBD_PRECISE_BURST_0 = 0x00000000L,
    CUSBD_PRECISE_BURST_1 = 0x01000000L,
    CUSBD_PRECISE_BURST_2 = 0x02000000L,
    CUSBD_PRECISE_BURST_4 = 0x04000000L,
    CUSBD_PRECISE_BURST_8 = 0x08000000L,
    CUSBD_PRECISE_BURST_16 = 0x10000000L,
    CUSBD_PRECISE_BURST_32 = 0x20000000L,
    CUSBD_PRECISE_BURST_64 = 0x40000000L,
    CUSBD_PRECISE_BURST_128 = 0x80000000L,
} CUSBD_PreciseBurstLength;
...
typedef struct CUSBD_Config
{
    ...
    struct CUSBD_EpConfig epIN[1];
    /** table of endpoint configuration objects for OUT direction */
    struct CUSBD_EpConfig epOUT[1];
    /**
    ...
    */
     ...
     * PRECISE_BURST_128
    */
    CUSBD_PreciseBurstLength preciseBurstLength;
