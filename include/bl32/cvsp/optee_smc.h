...
#define OPTEE_SMC_FUNID_CV_OTP3_READ 0x06
#define OPTEE_SMC_FUNID_CV_OTP3_WRITE 0x07

#define OPTEE_SMC_FUNID_CV_SPACC_EXEC 0x0A
#define OPTEE_SMC_FUNID_CV_TRNG_INIT  0x0B
#define OPTEE_SMC_FUNID_CV_TRNG_READ  0x0C
...
#define OPTEE_SMC_CALL_CV_DEBUG                                                \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_DEBUG)
...
#define OPTEE_SMC_CALL_CV_TPU_RUN                                              \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_TPU_RUN)

#define OPTEE_SMC_CALL_CV_TPU_WAIT                                             \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_TPU_WAIT)

#define OPTEE_SMC_CALL_CV_TPU_SET_PROT_RANGE                                     \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_TPU_SET_PROT_RANGE)

#define OPTEE_SMC_CALL_CV_TPU_CLEAR_PROT_RANGE                                     \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_TPU_CLEAR_PROT_RANGE)

#define OPTEE_SMC_CALL_CV_OTP3_READ                                           \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_OTP3_READ)

#define OPTEE_SMC_CALL_CV_OTP3_WRITE                                          \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_OTP3_WRITE)

#define OPTEE_SMC_CALL_CV_SPACC_EXEC                                     \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_SPACC_EXEC)

#define OPTEE_SMC_CALL_CV_TRNG_INIT                                     \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_TRNG_INIT)

#define OPTEE_SMC_CALL_CV_TRNG_READ                                    \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_TRNG_READ)

#define OPTEE_SMC_CALL_CV_BASE64	                                   \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_SPACC_BASE64)

#define OPTEE_SMC_CALL_CV_SHA256									   \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
