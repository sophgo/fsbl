...
#define OPTEE_SMC_CALL_CV_TPU_SET_PROT_RANGE                                   \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM,                                \
			   OPTEE_SMC_FUNID_CV_TPU_SET_PROT_RANGE)

#define OPTEE_SMC_CALL_CV_TPU_CLEAR_PROT_RANGE                                 \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM,                                \
			   OPTEE_SMC_FUNID_CV_TPU_CLEAR_PROT_RANGE)

#define OPTEE_SMC_CALL_CV_EFUSE_READ                                            \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_EFUSE_READ)

#define OPTEE_SMC_CALL_CV_EFUSE_WRITE                                           \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM, OPTEE_SMC_FUNID_CV_EFUSE_WRITE)
...
#define OPTEE_SMC_CALL_CV_BASE64                                               \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM,                                \
			   OPTEE_SMC_FUNID_CV_SPACC_BASE64)

#define OPTEE_SMC_CALL_CV_SHA256                                               \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_32, OPTEE_SMC_STD_CALL,                   \
			   OPTEE_SMC_OWNER_OEM,                                \
			   OPTEE_SMC_FUNID_CV_SPACC_SHA256)
