...
#endif
#ifdef FULL_MEM_BIST
uint32_t ddr_bist_all(uint32_t ddr_bist_base, uint32_t cfg_base, uint64_t bist_start_addr, uint32_t mode, uint64_t capacity, uint32_t x16_mode);
uint32_t bist_all_dram(uint32_t uSysid, uint32_t mode, uint64_t uSys_cap_in_mbyte, uint32_t x16_mode);
#endif
