...
void ddrc_init(void)
{
	...
	mmio_wr32(0x08004000 + 0x148, 0x989E0000);
	...
	mmio_wr32(0x08004000 + 0x64, 0x0061008C);
...
#else
	mmio_wr32(0x08004000 + 0xd0, 0x000100C5);
	mmio_wr32(0x08004000 + 0xd4, 0x005B0000);
#endif
...
#endif
	mmio_wr32(0x08004000 + 0xe4, 0x000903BF);
	mmio_wr32(0x08004000 + 0x100, 0x0C101A0E);
	if (get_ddr_vendor() == DDR_VENDOR_ETRON_1G)
		mmio_wr32(0x08004000 + 0x100, mmio_rd32(0x08004000 + 0x100) + 0x3000000);
	mmio_wr32(0x08004000 + 0x104, 0x00030314);
	mmio_wr32(0x08004000 + 0x108, 0x04060509);
	mmio_wr32(0x08004000 + 0x10c, 0x00002006);
	mmio_wr32(0x08004000 + 0x110, 0x06020306);
	mmio_wr32(0x08004000 + 0x114, 0x04040302);
	mmio_wr32(0x08004000 + 0x120, 0x00000906);
	mmio_wr32(0x08004000 + 0x13c, 0x00000000);
	mmio_wr32(0x08004000 + 0x180, 0xC0800020);
	...
	mmio_wr32(0x08004000 + 0x1a4, 0x00B100FF);
	...
	// auto gen.
	mmio_wr32(0x08004000 + 0x240, 0x0800060C);
#ifdef DDR_DODT
...
void ctrl_init_update_by_dram_size(uint8_t dram_cap_in_mbyte)
{
	...
	case 6:
		mmio_wr32(0x08004000 + 0x64, 0x00610024);
		mmio_wr32(0x08004000 + 0x120, 0x00000903);
		break;
	case 7:
		mmio_wr32(0x08004000 + 0x64, 0x0061002C);
		mmio_wr32(0x08004000 + 0x120, 0x00000903);
		break;
	case 8:
		mmio_wr32(0x08004000 + 0x64, 0x00610040);
		mmio_wr32(0x08004000 + 0x120, 0x00000904);
		break;
	case 9:
		mmio_wr32(0x08004000 + 0x64, 0x00610068);
