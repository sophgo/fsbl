...
#define  DDR_PHY_REG_24_DATA  0b00000100000100000011001011011000
...
#define  DDR_PHY_REG_25_DATA  0b00110110000000000010001100000000                         //start shift code 23  end shift code 36
...
#define  DDR_PHY_REG_26_DATA  0b01111001110000000000000000000000                 //rx_en = e -> 1c en_odt = e -> 1e wzl
...
#define  DDR_PHY_REG_33_DATA  0b00000100000101000000110000001010
...
#define  DDR_PHY_REG_129_DATA  0b00000000000000000000000101000000
...
#define  DDR_PHY_REG_137_DATA  0b00000000000000000000000101000000
...
#define  DDR_PHY_REG_145_DATA  0b00000000000000000000000101000000
...
#define  DDR_PHY_REG_153_DATA  0b00000000000000000000000101000000
...
#define  DDR_PHY_REG_325_F0_DATA  0b00000000100010110000000010001011
    ...
    #define  DDR_PHY_REG_326_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00  
...
//#define  DDR_PHY_REG_327_F0_DATA  0b00011100010000000000100100001101   //en_shift = d odt_en_shift = 9
    ...
    #define  DDR_PHY_REG_327_F0_DATA  0b00010010010000000000100000001010   //en_shift = a odt_en_shift = 8 sel_rankb_rx_shift = h12
#else
...
//#define  DDR_PHY_REG_328_F0_DATA  0b00000000000011010001011000010010   //en_extend += 0 odt_en_extend += 4
    ...
    #define  DDR_PHY_REG_328_F0_DATA  0b00000000000011010001010000010010   //en_extend += 0 odt_en_extend += 2
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_328_F0_DATA  0b00000000000101000011001000101110   //en_extend += b+2+5+10 odt_en_extend += d+4+5+10 rden_to_rdvld +=5
#else
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_350_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00
#elif defined(AUTO_GATED_PASS)
...
//#define  DDR_PHY_REG_351_F0_DATA  0b00011100010000000000100100001101   //en_shift = d odt_en_shift = 9
    ...
    #define  DDR_PHY_REG_351_F0_DATA  0b00011100010000000000101100001101   //en_shift = d odt_en_shift = b
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_351_F0_DATA  0b00010010010000000000100000001010   //en_shift = a odt_en_shift = 8 sel_rankb_rx_shift = h12
#else
    #define  DDR_PHY_REG_351_F0_DATA  0b00011100010000000000110100001101
#endif
...
//#define  DDR_PHY_REG_352_F0_DATA  0b00000000000011010001011000010010   //en_extend += 0 odt_en_extend += 4
    ...
    #define  DDR_PHY_REG_352_F0_DATA  0b00000000000011010001010000010010   //en_extend += 0 odt_en_extend += 2
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_352_F0_DATA  0b00000000000101000011001000101110   //en_extend += b+2+5+10 odt_en_extend += d+4+5+10 rden_to_rdvld +=5
#else
    #define  DDR_PHY_REG_352_F0_DATA  0b00000000000011010001001000010010
#endif
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_374_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00
#elif defined(AUTO_GATED_PASS)
...
//#define  DDR_PHY_REG_375_F0_DATA  0b00011100010000000000100100001101   //en_shift = d odt_en_shift = 9
    ...
    #define  DDR_PHY_REG_375_F0_DATA  0b00011100010000000000101100001101   //en_shift = d odt_en_shift = b
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_375_F0_DATA  0b00010010010000000000100000001010   //en_shift = a odt_en_shift = 8 sel_rankb_rx_shift = h12
#else
    #define  DDR_PHY_REG_375_F0_DATA  0b00011100010000000000110100001101
#endif
...
//#define  DDR_PHY_REG_376_F0_DATA  0b00000000000011010001011000010010   //en_extend += 0 odt_en_extend += 4
    ...
    #define  DDR_PHY_REG_376_F0_DATA  0b00000000000011010001010000010010   //en_extend += 0 odt_en_extend += 2
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_376_F0_DATA  0b00000000000101000011001000101110   //en_extend += b+2+5+10 odt_en_extend += d+4+5+10 rden_to_rdvld +=5
#else
    #define  DDR_PHY_REG_376_F0_DATA  0b00000000000011010001001000010010
#endif
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_398_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00
#elif defined(AUTO_GATED_PASS)
...
//#define  DDR_PHY_REG_399_F0_DATA  0b00011100010000000000100100001101   //en_shift = d odt_en_shift = 9
    ...
    #define  DDR_PHY_REG_399_F0_DATA  0b00011100010000000000101100001101   //en_shift = d odt_en_shift = b
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_399_F0_DATA  0b00010010010000000000100000001010   //en_shift = a odt_en_shift = 8 sel_rankb_rx_shift = h12
#else
    #define  DDR_PHY_REG_399_F0_DATA  0b00011100010000000000110100001101
#endif
...
//#define  DDR_PHY_REG_400_F0_DATA  0b00000000000011010001011000010010   //en_extend += 0 odt_en_extend += 4
    ...
    #define  DDR_PHY_REG_400_F0_DATA  0b00000000000011010001010000010010   //en_extend += 0 odt_en_extend += 2
#elif defined(LP4_4X_ODT_EN_EXTEND0)
    #define  DDR_PHY_REG_400_F0_DATA  0b00000000000101000011001000101110   //en_extend += b+2+5+10 odt_en_extend += d+4+5+10 rden_to_rdvld +=5
#else
    #define  DDR_PHY_REG_400_F0_DATA  0b00000000000011010001001000010010
#endif
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_710_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00 
#elif defined(AUTO_GATED_PASS)
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_734_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00
#elif defined(AUTO_GATED_PASS)
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_758_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00
#elif defined(AUTO_GATED_PASS)
...
#ifdef MASK_SHIFT_FW_1T
    #define  DDR_PHY_REG_782_F0_DATA  0b00101000010000000010011000000000  //mask_shift 1c -> 26  mask_ranka 40-> 00 
#elif defined(AUTO_GATED_PASS)
...
#define  DDR_PHY_REG_1_F0_DATA         0b00000000000000000000110110110110
...
#define  DDR_PHY_REG_171_DATA          0b00000000000000000000000011001100
										...
										// param_phya_reg_tx_ca_clk0_sel_lpddr_4x:[3:3]=0b1
										...
										// param_phya_reg_tx_ca_clk1_sel_lpddr_4x:[7:7]=0b1
#ifdef AUTO_GATED
#define  DDR_PHY_REG_170_DATA          0b01000100010001000100010001000100
#else
#define  DDR_PHY_REG_170_DATA          0b11001100110011000000000000000000
#endif
										...
										// param_phya_reg_tx_byte0_sel_lpddr4x:[19:19]=0b1
										// param_phya_reg_tx_byte1_sel_4bit_mode_tx:[22:22]=0b1
										// param_phya_reg_tx_byte1_sel_lpddr4x:[23:23]=0b1
										// param_phya_reg_tx_byte2_sel_4bit_mode_tx:[26:26]=0b1
										// param_phya_reg_tx_byte2_sel_lpddr4x:[27:27]=0b1
										// param_phya_reg_tx_byte3_sel_4bit_mode_tx:[30:30]=0b1
										// param_phya_reg_tx_byte3_sel_lpddr4x:[31:31]=0b1
...
#define  DDR_PHY_REG_168_DATA          0b01000011000100000011000000110000
										...
										// param_phya_reg_tx_clk0_sel_lpddr_4x:[20:20]=0b1  
										...
										// param_phya_reg_tx_clk1_sel_lpddr_4x:[24:24]=0b1  
...
#define  DDR_PHY_REG_164_DATA          0b00011010000110100001101000011010 
...
#define  DDR_PHY_REG_155_DATA          0b00000001101110110100000000000000
										// param_phya_reg_rx_byte3_sel_4bit_mode_rx:[14:14]=0b1
										// param_phya_reg_rx_byte3_sel_dqs_wo_pream_mode:[15:15]=0b0
...
#define  DDR_PHY_REG_147_DATA          0b00000001101110110100000000000000
										// param_phya_reg_rx_byte2_sel_4bit_mode_rx:[14:14]=0b1
										// param_phya_reg_rx_byte2_sel_dqs_wo_pream_mode:[15:15]=0b0
...
#define  DDR_PHY_REG_139_DATA          0b00000001101110110100000000000000
										// param_phya_reg_rx_byte1_sel_4bit_mode_rx:[14:14]=0b1
										// param_phya_reg_rx_byte1_sel_dqs_wo_pream_mode:[15:15]=0b0
...
#define  DDR_PHY_REG_131_DATA          0b00000001101110110100000000000000
										// param_phya_reg_rx_byte0_sel_4bit_mode_rx:[14:14]=0b1
										// param_phya_reg_rx_byte0_sel_dqs_wo_pream_mode:[15:15]=0b0
