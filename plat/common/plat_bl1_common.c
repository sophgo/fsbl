...
image_desc_t *bl1_plat_get_prg_bin_image_desc(unsigned int image_id)
{
	static image_desc_t prg_bin_img_desc = PRG_BIN_IMAGE_DESC; //PRG_BIN_IMAGE_ID

	return &prg_bin_img_desc;
}
#endif
