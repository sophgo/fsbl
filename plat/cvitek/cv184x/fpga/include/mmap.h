...
#define RISCV_BL1_ROM_PSMSK_VALUE BIT(23)
#define CA53_BL1_ROM_PSMSK_VALUE BIT(11)
...
#define BL32_RUNADDR (CVIMMAP_MONITOR_ADDR + 0x50000)
#define BLMCU_RUNADDR 0x05200000
#define LICENSE_FILE_ADDR (DRAM_BASE + 0x20020) // in ATF

#define DECOMP_ALLOC_SIZE BIT(20)
...
#ifdef CVIMMAP_RTOS_COMPRESS_BIN_ADDR
#define BLCP_2ND_COMP_ADDR CVIMMAP_RTOS_COMPRESS_BIN_ADDR
#define BLCP_2ND_DECOMP_DST_SIZE CVIMMAP_RTOS_SYS_SIZE
#else
#define BLCP_2ND_COMP_ADDR 0
#define BLCP_2ND_DECOMP_DST_SIZE 0
#endif
...
//rtc sram addr: 0x5200000, size: 32k 0x8000
