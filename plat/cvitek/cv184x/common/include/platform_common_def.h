...
#define REG_DISPPLL_SSC_SYN_SPAN (PLL_G2_BASE + 0x68)
#define REG_DISPPLL_SSC_SYN_STEP (PLL_G2_BASE + 0x6C)
#define REG_CAM0PLL_SSC_SYN_CTRL (PLL_G2_BASE + 0x70)
#define REG_CAM0PLL_SSC_SYN_SET (PLL_G2_BASE + 0x74)
#define REG_CAM0PLL_SSC_SYN_SPAN (PLL_G2_BASE + 0x78)
#define REG_CAM0PLL_SSC_SYN_STEP (PLL_G2_BASE + 0x7C)
