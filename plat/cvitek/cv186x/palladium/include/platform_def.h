 ...
 */
#define PLAT_BM_CONSOLE_BAUDRATE			19200
#define PLAT_BM_BOOT_UART_CLK_IN_HZ			(19200*16)
...
#ifdef ATF_WAIT_DEBUG_TIMEOUT
#undef ATF_WAIT_DEBUG_TIMEOUT
#define ATF_WAIT_DEBUG_TIMEOUT			0
#endif
